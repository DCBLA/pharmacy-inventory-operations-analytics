...
The images below are selected, non-identifying slide excerpts from the original group presentation. Title, submission, student-ID, reference, and remit materials are excluded.
...
![Seasonal demand forecasting slide excerpt](assets/slide_seasonal_forecasting.png)

### Trade-Offs And Final Recommendation

![Final recommendation slide excerpt](assets/slide_final_recommendation.png)
...
|   |-- slide_seasonal_forecasting.png
|   `-- slide_final_recommendation.png
|-- docs/
|   |-- source_handling.md
|   `-- methods_summary.md
|-- results/
